...
export function SeedRound({ friends, onComplete, onCancel }) {
  ...
  const [state, setState] = useState(() => buildNextState(rankedOrder(friends, ATTR), queue, 0));
  ...
  return (
    <div
      style={overlay}
      onClick={(e) =>
        e.target === e.currentTarget && (compsDone === 0 ? onCancel() : setConfirmCancel(true))
      }
    >
      <div style={panel}>
        {/* Cancel confirm */}
        {confirmCancel && (
          ...
          >
            ...
            <div style={{ fontSize: 12, color: "#6b7280", marginBottom: 10 }}>
              {placedThisSession} friend{placedThisSession !== 1 ? "s" : ""} ranked so far won't be
              saved.
            </div>
        ...
        {!allDone && cmp && (
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ textAlign: "center", fontSize: 11, color: "#9ca3af" }}>
              placing{" "}
              <strong style={{ color: "#374151" }}>{friendMap[cmp.a]?.name ?? cmp.a}</strong>
            </div>
          </div>
        )}
        ...
        {allDone && (
          <div style={{ textAlign: "center", padding: "10px 0 20px" }}>
            ...
            <div style={{ fontSize: 12, color: "#6b7280" }}>
              {orderedIds.length} friends ranked. Drag to adjust if needed, then save.
            </div>
          </div>
        )}
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: "7px 10px",
                      borderRadius: 8,
                      background: isNew ? "#f5f3ff" : "#f9fafb",
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        color: isNew ? "#5b21b6" : "#374151",
                      }}
                    >
                      {fr?.name ?? id}
                    </span>
                    {fr?.groups?.slice(0, 1).map((g) => (
                      <Pill key={g} text={g} bg="#f3f4f6" c="#9ca3af" />
                    ))}
                    <span
                      style={{
                        fontSize: 11,
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 700,
            fontSize: 13,
            cursor: placedThisSession === 0 ? "default" : "pointer",
            fontFamily: "inherit",
          }}
        >
